...
Segundo passo: fazer o primeiro gráfico ggplot usando o dataframe criado, "mtc".
...
Para solucionar esse problema, deve ser explicitamente colocado que a variável "cyl" não é continua, mas categórica. Isso pode ser feito através do uso de **fator(cyl)** na estética dos dados.
...
Podemos colocar o tamanho do ponto (outra estética ou apariência), como mais um elemento gráfico. Isso é feito com o argumento **size* =** e assignando a variável "am " com fator novamente. 
