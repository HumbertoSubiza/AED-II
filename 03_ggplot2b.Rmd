...
Os dados contém informação referente a diversas características de diamantes, como preço, corte, color, dimensões de cada um, etc.
...
O gráfico acima ficou muito confuso. Temos várias possibilidades de melhorá-lo:
